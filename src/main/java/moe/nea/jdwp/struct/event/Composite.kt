...
class CompositeEventsElement : JDWPComposite() {
    ...
    /**
     * Notification of a thread about to wait on a monitor object. Requires canRequestMonitorEvents capability - see [CapabilitiesNew](https://docs.oracle.com/en/java/javase/17/docs/specs/jdwp/jdwp-protocol.html#JDWP_VirtualMachine_CapabilitiesNew). Since JDWP version 1.6.
     */
    var MonitorWait by useField(JDWPCase(this::eventKind, JDWPEventKindConstants.MONITOR_WAIT, CompositeMonitorWait()))
    /**
     * Notification that a thread in the target VM has finished waiting on Requires canRequestMonitorEvents capability - see [CapabilitiesNew](https://docs.oracle.com/en/java/javase/17/docs/specs/jdwp/jdwp-protocol.html#JDWP_VirtualMachine_CapabilitiesNew). a monitor object. Since JDWP version 1.6.
     */
    ...
    /**
     * Notification of a field access in the target VM. Field modifications are not considered field accesses. Requires canWatchFieldAccess capability - see [CapabilitiesNew](https://docs.oracle.com/en/java/javase/17/docs/specs/jdwp/jdwp-protocol.html#JDWP_VirtualMachine_CapabilitiesNew).
     */
    var FieldAccess by useField(JDWPCase(this::eventKind, JDWPEventKindConstants.FIELD_ACCESS, CompositeFieldAccess()))
    /**
     * Notification of a field modification in the target VM. Requires canWatchFieldModification capability - see [CapabilitiesNew](https://docs.oracle.com/en/java/javase/17/docs/specs/jdwp/jdwp-protocol.html#JDWP_VirtualMachine_CapabilitiesNew).
     */
...
class CompositeClassPrepare : JDWPComposite() {
    ...
    var thread by useField(JDWPThreadId())
    /**
     * Kind of reference type. See [JDWP.TypeTag](https://docs.oracle.com/en/java/javase/17/docs/specs/jdwp/jdwp-protocol.html#JDWP_TypeTag)
     */
    ...
    /**
     * Status of type. See [JDWP.ClassStatus](https://docs.oracle.com/en/java/javase/17/docs/specs/jdwp/jdwp-protocol.html#JDWP_ClassStatus)
     */
